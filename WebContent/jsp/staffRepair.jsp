  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/CheckSystem/jsp/staffTask.jsp"><i class="fa fa-user"></i> <span>巡检任务</span></a></li>
        <li><a href="/CheckSystem/jsp/staffCheckLog.jsp"><i class="fa fa-archive"></i> <span>巡检记录</span></a></li>
        <li><a href="/CheckSystem/jsp/staffRepair.jsp"><i class="fa fa-building"></i> <span>设备报修</span></a></li>
    </section>
  </aside>
